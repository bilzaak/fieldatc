<div id="right">
	...
	<div class="two">
		...
		<table align="center" width="100%" class="news">
			...
			<tr>
				<td>&nbsp; <img src="img/slideshow/01.png">&nbsp;&nbsp;&nbsp; <a href="result.php" class="admissionlinks">Examination Result</a></td>
			</tr>
			<tr>
				<td>&nbsp; <img src="img/slideshow/02.png">&nbsp;&nbsp;&nbsp; <a href="timetable.php" class="admissionlinks">Exam Timetable</a></td>
			</tr>
			<tr>
				<td>&nbsp; <img src="img/slideshow/03.png">&nbsp;&nbsp;&nbsp; <a href="graduation.php" class="admissionlinks">Graduation Day</a></td>
			</tr>
			<tr>
				<td>&nbsp; <img src="img/slideshow/04.png">&nbsp;&nbsp;&nbsp; <a href="downloads.php" class="admissionlinks">Downloads </a></td>
			</tr>
			<tr>
				<td>&nbsp; <img src="img/slideshow/05.png">&nbsp;&nbsp;&nbsp; <a href="scholarship.php" class="admissionlinks">Scholarship </a></td>
			</tr>
		</table>
	</div>
